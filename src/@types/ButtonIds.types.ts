/**
 * Button CustomId enums for Discord button interactions
 */

/**
 * Dashboard control button IDs
 */
export enum DashboardButtonId {
    PlayPause = 'dashboard-play-pause',
    Skip = 'dashboard-skip',
    Stop = 'dashboard-stop',
    Loop = 'dashboard-loop',
    Shuffle = 'dashboard-shuffle',
    LoopSelect = 'dashboard-loop-select',
}

/**
 * Queue list control button IDs
 */
export enum QueueButtonId {
    Previous = 'queue-prev',
    Next = 'queue-next',
    Delete = 'queue-delete',
    Clear = 'queue-clear',
...
export enum SelectButtonId {
    ...
    Music = 'select-music',
    FilterListCategory = 'select-filter-list-category',
    FilterListFilter = 'select-filter-list-filter',
}
